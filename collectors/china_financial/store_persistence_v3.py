...
def main()->int:
    ...
    latest={
      ...
      'consumer_contract':{
        'entrypoint':'data/china_financial/manifests/latest.json','standard_runtime_must_not_invoke_collectors':True,'standard_runtime_must_not_scrape_sources':True,
        'consumer_should_not_glob_all_historical_store_files':True,'consumer_reads_only_manifest_selected_active_paths':True,'collector_schedule_is_independent_of_model_invocation':True,
